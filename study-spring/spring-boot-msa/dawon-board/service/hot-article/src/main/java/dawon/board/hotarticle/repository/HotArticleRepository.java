package dawon.board.hotarticle.repository;
...
public class HotArticleRepository {
    ...
    private String generateKey(String dateSrt) {
        return KEY_FORMAT.formatted(dateSrt);
    }

    public List<Long> readAll(String dateSrt) {
        return redisTemplate.opsForZSet()
                .reverseRangeWithScores(generateKey(dateSrt),0, -1).stream()
                .peek(tuple ->
